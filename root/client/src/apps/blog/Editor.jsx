...
import { 
  ...
  FaCode, FaImage, FaLink, FaUnlink, FaYoutube,
    ...
    <div className="editor__toolbar">
      ...
      <div className="toolbar-group">
        <label className="color-picker-label" title="Text Color">
          ...
          <input type="color" onInput={(e) => editor.chain().focus().setColor(e.target.value).run()} value={editor.getAttributes('textStyle').color || "#ffffff"}/>
        </label>
      ...
      <div className="toolbar-group">
        ...
        <button type="button" onClick={addYoutubeVideo} title="Insert Video"><FaYoutube color="#ff0000" /></button>
