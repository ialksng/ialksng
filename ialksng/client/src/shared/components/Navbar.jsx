...
function Navbar() {
  ...
  const handleSearch = (e) => {
    ...
    if (searchQuery.trim()) {
      ...
      // navigate(`/store?search=${searchQuery}`); // Enable later when store search is ready
      setSearchQuery("");
      setMenuOpen(false);
    }
  };
    ...
    <header className={`navbar ${menuOpen ? "menu-open" : ""}`}>
      ...
      <nav className={`mobile__menu ${menuOpen ? "active" : ""}`}>
        ...
        <ul>
          ...
          <li onClick={() => setMenuOpen(false)}><NavLink to="/projects" className="nav__link">Work</NavLink></li>
