    ...
    <section className="legal-page">
      <div className="legal-page__container">
        ...
        <div className="legal-page__content">
          ...
          <p>We collect user data such as your name, email address, and payment details when you create an account, make a purchase, or contact us. User data is not shared with third parties except for payment processing.</p>

          <h3>2. Payment Information</h3>
          <p>All payments are processed securely via Razorpay. We do not store, process, or have access to your credit card details or bank account information on our servers.</p>
